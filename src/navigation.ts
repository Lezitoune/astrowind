...
/*   links: [
  ...
  footNote: `
    (Créé par onWidget) - 
    <span class="w-5 h-5 md:w-6 md:h-6 md:-mt-0.5 bg-cover mr-1.5 rtl:mr-0 rtl:ml-1.5 rtl:float-right rounded-sm bg-[url(https://www.oliviernuber.com/images/Logo-Jaune-Fond-Trans-32x32.png)]"style="position: absolute;"></span>
